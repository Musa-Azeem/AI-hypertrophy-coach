...
Deployment on a Raspberry Pi 5 validates the system's suitability for low-power, portable applications. Unlike cloud-dependent solutions, edge processing ensures privacy-preserving operation in environments with limited connectivity, such as commercial gyms or home setups. The 640 ms update stride (1.56 Hz) and low model latency of 139 ms provides timely feedback without overwhelming users, striking a balance between responsiveness and computational efficiency. 
