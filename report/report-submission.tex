...
\begin{figure}[b]
    ...
    \caption{\textbf{Deployed model latency on Raspberry Pi.} 100 predictions were made in this session, 69 of which were made on a full list of 32 input windows. The average latency of those 69 predictions was used for this figure's last data point.}
